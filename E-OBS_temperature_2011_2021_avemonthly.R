...
#simple plot example
d<-1
tmp_slice<-tmp_array[,,d] #get a single time slice of the data
...
#creat a dataframe without missing values
tmp_df03<-na.omit(tmp_df02)


save(tmp_df03,file = "I:/Projekte/OpenEntrance - WV0173/Durchführungsphase/WP6/CS1/OE_data_analysis/openEntrance/data/temperature/tg_mean025_2011_2021.RData")
